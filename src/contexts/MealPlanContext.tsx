...
import { ShoppingProvider, useShopping } from './shopping';
import { MealDataProvider, useMealData } from './MealDataContext';
import { RecipeProvider, useRecipes } from './RecipeContext'; // Fixed: useRecipe → useRecipes
import { InventoryProvider } from './InventoryContext';
import { InventoryContext } from './InventoryContextDefinition'; // Added to properly access inventory context
import { ShoppingItem, Recipe, InventoryItem } from '@/types/mealPlanTypes';
...
// Import or define CompleteRecipe type
type CompleteRecipe = Recipe; // Temporary alias until proper type is defined
